...
\begin{figure}
  \begin{center}
  \includegraphics[width=0.55\linewidth]{./images/ribonucleic_acids_trna.png}
  \end{center}
  
  \begin{center}
  \includegraphics[width=0.45\linewidth]{./images/ribonucleic_acids_types.png}
  \end{center}
