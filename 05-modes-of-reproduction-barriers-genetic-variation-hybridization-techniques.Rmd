...
```{r si-use-sc, fig.cap="Production of single cross hybrid using inbred lines and sporophytic self incompatibility", out.width="60%", fig.align='center'}
...
```{r si-use-dc, fig.cap="Production of double cross hybrid using inbred lines and sporophytic self incompatibility", out.width="60%", fig.align='center'}
# pdftools::pdf_convert("./../../references_plb/Principles of Plant Genetics and Breeding.pdf", pages = 118, format = "png", filenames = "./images/incompatibility_use.png", dpi = 300)
...
```{r si-use-tc, fig.cap="Production of triple cross hybrid using inbred lines and sporophytic self incompatibility", out.width="55%", fig.align='center'}
# pdftools::pdf_convert("./../../references_plb/Principles of Plant Genetics and Breeding.pdf", pages = 118, format = "png", filenames = "./images/incompatibility_use.png", dpi = 300)
